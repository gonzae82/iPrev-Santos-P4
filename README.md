...
Este projeto foi desenvolvido para a disciplina de Projeto Integrador em Computação IV da UNIVESP, em parceria com o Instituto de Previdência dos Servidores Públicos Municipais de Santos (IPREVSANTOS).

O objetivo é solucionar os desafios enfrentados pela instituição na integração, organização e interpretação de seus dados de custos. Para isso, foi desenvolvida uma ferramenta de ciência de dados que utiliza **Python** e modelos de **Machine Learning** para consolidar informações financeiras e gerar análises preditivas.
...
- **Nome**: Projeto Integrador em Computação IV - DRP02 
- **Turma**: 001 - Projeto Integrador em Computação IV - Grupo: 005
